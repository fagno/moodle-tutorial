...
WARNING: Professores dos campi PORTO NACIONAL, GURUPI, COLINAS, ARAGUATINS, DIANOPOLIS, AVANÇADO PEDRO AFONSO E AVANÇADO FORMOSO DO ARAGUAINA, em caso de problemas devem entrar em contato com o responsável do seu campus através do e-mail abaixo.
