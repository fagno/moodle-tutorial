...
=== Criação de grupos de estudantes dentro da disciplina
...
Veja os passos para a criação dos grupos:

- Na disciplina selecionada, acesse o ícone engrenagem como mostra a Figura 1
