...
image::notificacao1.png[width=50,height=50] 
...
image::notificacao2.png[width=50,height=50] 

3. Habilite os itens Conectado e Offline, como mostra na Figura 3.

image::notificacao3.png[width=50,height=50] 
...
image::notificacao4.png[width=50,height=50] 
