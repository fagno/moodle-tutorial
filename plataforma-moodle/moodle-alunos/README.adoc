...
1. Ao logar na plataforma, acesse o ícone sino como mostra a Figura 1. Observe na Figura 1 o ícone engrenagem, clique neste ícone para acessar as configurações.
