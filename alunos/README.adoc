...
Para ter acesso a plataforma Moodle é necessário que o aluno esteja cadastrado na mesma.

IMPORTANT: Alunos devem utilizar os mesmos dados de acesso ao sistema acadêmico SIGA.
...
WARNING: Aos Alunos dos campus PORTO NACIONAL, GURUPI, COLINAS, ARAGUATINS, DIANOPOLIS, AVANÇADO PEDRO AFONSO E AVANÇADO FORMOSO DO ARAGUAINA, devem entrar em contato com o responsável do seu campus através do e-mail abaixo em caso de problemas.
...
WARNING: Quando os estudantes e professores dos Campus citado acima forem cadastrados na plataforma, os responsáveis serão comunicados.


Existem dois ambientes Moodle principais no IFTO:

- Moodle Reitoria: apenas cursos do ensino à distância e campus listado acima, endereço: https://moodle.ifto.edu.br
- Moodle Palmas: cursos presenciais do campus Palmas, endereço: https://moodlepalmas.ifto.edu.br

WARNING: Estudantes do Campus Palmas tentam equivocadamente acessar o Moodle da Reitoria.
