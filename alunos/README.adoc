...
Para ter acesso a plataforma Moodle é necessário que o aluno esteja cadastrado na plataforma. Este cadastro é efetuado pela equipe de suporte da mesma, em caso de problemas com acesso, entrar em contato através do e-mail: https://moodle.palmas@ifto.edu.br.

Alunos devem utilizar os mesmos dados de acesso ao sistema acadêmico SIGA.
...
Para os estudantes dos Campus listado abaixo, o acesso é através do Moodle Reitoria no endereço: https://moodle.ifto.edu.br.

Assim que forem cadastrados na plataforma, o acesso na mesma é com os dados do SIGA.
